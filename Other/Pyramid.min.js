(function () {
    var o = null; d3 = { version: "0.19.1" }; if (!Date.now) Date.now = function () { return +new Date }; if (!Object.create) Object.create = function (a) { function d() { } d.prototype = a; return new d }; function w(a) { return Array.prototype.slice.call(a) } function D(a, d) { d = w(arguments); d[0] = this; a.apply(this, d); return this } d3.range = function (a, d, e) { if (arguments.length == 1) { d = a; a = 0 } if (e == o) e = 1; if ((d - a) / e == Infinity) throw Error("infinite range"); var f = [], b = -1, c; if (e < 0) for (; (c = a + e * ++b) > d;)f.push(c); else for (; (c = a + e * ++b) < d;)f.push(c); return f };
    ...
    d3.interpolateString = function (a, d) {
        var e, f, b = 0, c = [], h = [], g, i; for (f = 0; e = K.exec(d); ++f) { e.index && c.push(d.substring(b, e.index)); h.push({ a: c.length, x: e[0] }); c.push(o); b = K.lastIndex } b < d.length && c.push(d.substring(b)); f = 0; for (g = h.length; (e = K.exec(a)) && f < g; ++f) {
            i = h[f]; if (i.x == e[0]) {
                if (i.a) if (c[i.a + 1] == o) { c[i.a - 1] += i.x; c.splice(i.a, 1); for (e = f + 1; e < g; ++e)h[e].a-- } else { c[i.a - 1] += i.x + c[i.a + 1]; c.splice(i.a, 2); for (e = f + 1; e < g; ++e)h[e].a -= 2 } else if (c[i.a + 1] == o) c[i.a] = i.x; else {
                c[i.a] = i.x + c[i.a + 1]; c.splice(i.a + 1, 1);
                    for (e = f + 1; e < g; ++e)h[e].a--
                } h.splice(f, 1); g--; f--
            } else i.x = d3.interpolateNumber(parseFloat(e[0]), parseFloat(i.x))
        } for (; f < g;) { i = h.pop(); if (c[i.a + 1] == o) c[i.a] = i.x; else { c[i.a] = i.x + c[i.a + 1]; c.splice(i.a + 1, 1) } g-- } if (c.length == 1) return c[0] == o ? h[0].x : function () { return d }; return function (j) { for (f = 0; f < g; ++f)c[(i = h[f]).a] = i.x(j); return c.join("") }
    };
    ...
    function L(a, d, e) {
        var f, b, c, h, g; if (h = /([a-z]+)\((.*)\)/i.exec(a)) { g = h[2].split(","); switch (h[1]) { case "hsl": return e(parseFloat(g[0]), parseFloat(g[1]) / 100, parseFloat(g[2]) / 100); case "rgb": return d(P(g[0]), P(g[1]), P(g[2])) } } if (e = J[a]) return d(e.r, e.g, e.b); if (a == o) return d(0, 0, 0); if (a.charAt(0) == "#") { if (a.length == 4) { f = a.charAt(1); f += f; b = a.charAt(2); b += b; c = a.charAt(3); c += c } else if (a.length == 7) { f = a.substring(1, 3); b = a.substring(3, 5); c = a.substring(5, 7) } f = parseInt(f, 16); b = parseInt(b, 16); c = parseInt(c, 16) } return d(f,
            b, c)
    } function na(a, d, e) { var f = Math.min(a /= 255, d /= 255, e /= 255), b = Math.max(a, d, e), c = b - f, h = (b + f) / 2; if (c) { f = h < 0.5 ? c / (b + f) : c / (2 - b - f); a = a == b ? (d - e) / c + (d < e ? 6 : 0) : d == b ? (e - a) / c + 2 : (a - d) / c + 4; a *= 60 } else f = a = 0; return Q(a, f, h) } function P(a) { var d = parseFloat(a); return a.charAt(a.length - 1) == "%" ? Math.round(d * 2.55) : d }
    var J = {
    ...
    }, R; for (R in J) J[R] = L(J[R], M, N); d3.hsl = function (a, d, e) { return arguments.length == 1 ? L("" + a, na, Q) : Q(+a, +d, +e) };
    ...
    function S(a) {
        function d(b) { for (var c = [], h, g, i, j, m = 0, p = a.length; m < p; m++) { i = a[m]; c.push(h = []); h.parentNode = i.parentNode; h.parentData = i.parentData; for (var r = 0, k = i.length; r < k; r++)if (j = i[r]) { h.push(g = b(j)); if (g && "__data__" in j) g.__data__ = j.__data__ } else h.push(o) } return S(c) } function e(b) { for (var c = [], h, g, i, j = 0, m = a.length; j < m; j++) { g = a[j]; for (var p = 0, r = g.length; p < r; p++)if (i = g[p]) { c.push(h = b(i)); h.parentNode = i; h.parentData = i.__data__ } } return S(c) } function f(b) {
            for (var c = 0, h = a.length; c < h; c++)for (var g = a[c],
                i = 0, j = g.length; i < j; i++) { var m = g[i]; if (m) return b.call(m, m.__data__, i) } return o
        } a.select = function (b) { return d(function (c) { return c.querySelector(b) }) }; a.selectAll = function (b) { return e(function (c) { return w(c.querySelectorAll(b)) }) }; a.filter = function (b) { for (var c = [], h, g, i, j = 0, m = a.length; j < m; j++) { g = a[j]; c.push(h = []); h.parentNode = g.parentNode; h.parentData = g.parentData; for (var p = 0, r = g.length; p < r; p++)if ((i = g[p]) && b.call(i, i.__data__, p)) h.push(i) } return S(c) }; a.data = function (b, c) {
            function h(k, n) {
                function q(pa) { return k.parentNode.appendChild(pa) }
                var l = 0, s = k.length, t = n.length, u = Math.min(s, t), A = Math.max(s, t), x = [], y = [], v = [], z, B; if (c) { u = {}; A = []; var C; B = n.length; for (l = 0; l < s; l++) { C = c.nodeKey(z = k[l]); if (C in u) v[B++] = k[l]; else { u[C] = z; A.push(C) } } for (l = 0; l < t; l++) { if (z = u[C = c.dataKey(B = n[l])]) { z.__data__ = B; x[l] = z; y[l] = v[l] = o } else { y[l] = { appendChild: q, __data__: B }; x[l] = v[l] = o } delete u[C] } for (l = 0; l < s; l++)if (A[l] in u) v[l] = k[l] } else {
                    for (; l < u; l++) { z = k[l]; B = n[l]; if (z) { z.__data__ = B; x[l] = z; y[l] = v[l] = o } else { y[l] = { appendChild: q, __data__: B }; x[l] = v[l] = o } } for (; l <
                        t; l++) { y[l] = { appendChild: q, __data__: n[l] }; x[l] = v[l] = o } for (; l < A; l++) { v[l] = k[l]; y[l] = x[l] = o }
                } y.parentNode = x.parentNode = v.parentNode = k.parentNode; y.parentData = x.parentData = v.parentData = k.parentData; m.push(y); p.push(x); r.push(v)
            } var g = -1, i = a.length, j, m = [], p = [], r = []; if (typeof c == "string") c = qa(c); if (typeof b == "function") for (; ++g < i;)h(j = a[g], b.call(j, j.parentData, g)); else for (; ++g < i;)h(j = a[g], b); g = S(p); g.enter = function (k) { return S(m).append(k) }; g.exit = function () { return S(r) }; return g
        }; a.each = function (b) {
            for (var c =
                0, h = a.length; c < h; c++)for (var g = a[c], i = 0, j = g.length; i < j; i++) { var m = g[i]; m && b.call(m, m.__data__, i) } return a
        }; a.node = function () { return f(function () { return this }) }; a.attr = function (b, c) {
            function h() { this.removeAttribute(b) } function g() { this.removeAttributeNS(b.space, b.local) } function i() { this.setAttribute(b, c) } function j() { this.setAttributeNS(b.space, b.local, c) } function m() { var r = c.apply(this, arguments); r == o ? this.removeAttribute(b) : this.setAttribute(b, r) } function p() {
                var r = c.apply(this, arguments); r == o ?
                    this.removeAttributeNS(b.space, b.local) : this.setAttributeNS(b.space, b.local, r)
            } b = d3.ns.qualify(b); if (arguments.length < 2) return f(b.local ? function () { return this.getAttributeNS(b.space, b.local) } : function () { return this.getAttribute(b) }); return a.each(c == o ? b.local ? g : h : typeof c == "function" ? b.local ? p : m : b.local ? j : i)
        }; a.style = function (b, c, h) {
            function g() { this.style.removeProperty(b) } function i() { this.style.setProperty(b, c, h) } function j() {
                var m = c.apply(this, arguments); m == o ? this.style.removeProperty(b) : this.style.setProperty(b,
                    m, h)
            } if (arguments.length < 3) h = o; if (arguments.length < 2) return f(function () { return window.getComputedStyle(this, o).getPropertyValue(b) }); return a.each(c == o ? g : typeof c == "function" ? j : i)
        }; a.property = function (b, c) { function h() { delete this[b] } function g() { this[b] = c } function i() { var j = c.apply(this, arguments); if (j == o) delete this[b]; else this[b] = j } b = d3.ns.qualify(b); if (arguments.length < 2) return f(function () { return this[b] }); return a.each(c == o ? h : typeof c == "function" ? i : g) }; a.text = function (b) {
            function c() { this.appendChild(document.createTextNode(b)) }
            function h() { var g = b.apply(this, arguments); g != o && this.appendChild(document.createTextNode(g)) } if (arguments.length < 1) return f(function () { return this.textContent }); a.each(function () { for (; this.lastChild;)this.removeChild(this.lastChild) }); return b == o ? a : a.each(typeof b == "function" ? h : c)
        }; a.html = function (b) { function c() { this.innerHTML = b } function h() { this.innerHTML = b.apply(this, arguments) } if (arguments.length < 1) return f(function () { return this.innerHTML }); return a.each(typeof b == "function" ? h : c) }; a.append =
            function (b) { function c(g) { return g.appendChild(document.createElement(b)) } function h(g) { return g.appendChild(document.createElementNS(b.space, b.local)) } b = d3.ns.qualify(b); return d(b.local ? h : c) }; a.remove = function () { return d(function (b) { var c = b.parentNode; c.removeChild(b); return c }) }; a.sort = function (b) { b = ra.apply(this, arguments); for (var c = 0, h = a.length; c < h; c++) { var g = a[c]; g.sort(b); for (var i = 1, j = g.length, m = g[0]; i < j; i++) { var p = g[i]; if (p) { m && m.parentNode.insertBefore(p, m.nextSibling); m = p } } } return a }; a.on =
                function (b, c) { b = "on" + b; return a.each(function (h, g) { this[b] = function (i) { var j = d3.event; d3.event = i; try { c.call(this, h, g) } finally { d3.event = j } } }) }; a.transition = function () { return U(a) }; a.call = D; return a
    } function qa(a) { return { nodeKey: function (d) { return d.getAttribute(a) }, dataKey: function (d) { return d[a] } } } function ra(a) { arguments.length || (a = sa); return function (d, e) { return a(d && d.__data__, e && e.__data__) } } function sa(a, d) { return a < d ? -1 : a > d ? 1 : 0 } d3.transition = T.transition; var ta = 0, V = 0;
    function U(a) {
        function d(k) {
            var n = true, q = -1; a.each(function () {
                if (i[++q] != 2) {
                    var l = (k - j[q]) / m[q], s = this.__transition__, t, u = c[q]; if (l < 1) { n = false; if (!(l < 0)) { if (i[q]) { if (s.c != f) { i[q] = 2; return } } else if (!s || s.c > f) { i[q] = 2; return } else { i[q] = 1; g.start.dispatch.apply(this, arguments); u = c[q] = {}; s.c = f; for (t in b) u[t] = b[t].apply(this, arguments) } s = r(l); for (t in b) u[t].call(this, s) } } else {
                    i[q] = 2; if (s.c == f) {
                        l = s.k; for (t in b) u[t].call(this, 1); if (l == f) { delete this.__transition__; h && this.parentNode.removeChild(this) } V =
                            f; g.end.dispatch.apply(this, arguments); V = 0; s.k = l
                    }
                    }
                }
            }); return n
        } var e = {}, f = V || ++ta, b = {}, c = [], h = false, g = d3.dispatch("start", "end"), i = [], j = [], m = [], p, r = d3.ease("cubic-in-out"); a.each(function () { (this.__transition__ || (this.__transition__ = {})).k = f }); e.delay = function (k) { var n = Infinity, q = -1; if (typeof k == "function") a.each(function () { var l = j[++q] = +k.apply(this, arguments); if (l < n) n = l }); else { n = +k; a.each(function () { j[++q] = n }) } ua(d, n); return e }; e.duration = function (k) {
            var n = -1; if (typeof k == "function") {
                p = 0; a.each(function () {
                    var q =
                        m[++n] = +k.apply(this, arguments); if (q > p) p = q
                })
            } else { p = +k; a.each(function () { m[++n] = p }) } return e
        }; e.ease = function (k) { r = typeof k == "string" ? d3.ease(k) : k; return e }; e.attrTween = function (k, n) { function q(s, t) { var u = n.call(this, s, t, this.getAttribute(k)); return function (A) { this.setAttribute(k, u(A)) } } function l(s, t) { var u = n.call(this, s, t, this.getAttributeNS(k.space, k.local)); return function (A) { this.setAttributeNS(k.space, k.local, u(A)) } } b["attr." + k] = k.local ? l : q; return e }; e.attr = function (k, n) {
            return e.attrTween(k,
                W(n))
        }; e.styleTween = function (k, n, q) { b["style." + k] = function (l, s) { var t = n.call(this, l, s, window.getComputedStyle(this, o).getPropertyValue(k)); return function (u) { this.style.setProperty(k, t(u), q) } }; return e }; e.style = function (k, n, q) { return e.styleTween(k, W(n), q) }; e.select = function (k) { var n; k = U(a.select(k)).ease(r); n = -1; k.delay(function () { return j[++n] }); n = -1; k.duration(function () { return m[++n] }); return k }; e.selectAll = function (k) {
            var n; k = U(a.selectAll(k)).ease(r); n = -1; k.delay(function (q, l) {
                return j[l ? n :
                    ++n]
            }); n = -1; k.duration(function (q, l) { return m[l ? n : ++n] }); return k
        }; e.remove = function () { h = true; return e }; e.each = function (k, n) { g[k].add(n); return e }; e.call = D; return e.delay(0).duration(250)
    } var X = o, Y = 0, Z; function ua(a, d) { var e = Date.now(), f = false, b = e + d, c = X; if (isFinite(d)) { for (; c;) { if (c.j == a) { c.i = e; c.delay = d; f = true } else { var h = c.i + c.delay; if (h < b) b = h } c = c.next } f || (X = { j: a, i: e, delay: d, next: X }); if (!Z) { clearTimeout(Y); Y = setTimeout(va, Math.max(24, b - e)) } } } function va() { Z = setInterval(wa, 24); Y = 0 }
    ...
    d3.scale.log = function () {
        function a(b) { return Math.log(b) / Math.LN10 } function d(b) { return Math.pow(10, b) } function e(b) { return f(a(b)) } var f = d3.scale.linear(); e.invert = function (b) { return d(f.invert(b)) }; e.domain = function (b) { if (!arguments.length) return f.domain().map(d); f.domain(b.map(a)); return e }; e.range = function () { var b = f.range.apply(f, arguments); return arguments.length ? e : b }; e.ticks = function () {
            var b = f.domain(), c = Math.floor(b[0]), h = Math.ceil(b[1]), g = []; if (b.every(isFinite)) {
                for (; ++c <= h;)for (b = 1; b < 10; b++)g.push(d(c) *
                    b); g.push(d(c))
            } return g
        }; e.tickFormat = function () { return function (b) { return b.toPrecision(1) } }; return e
    };
    ...
    d3.scale.ordinal = function () {
        function a(c) { c = c in e ? e[c] : e[c] = d.push(c) - 1; return f[c % f.length] } var d = [], e = {}, f = [], b = 0; a.domain = function (c) { if (!arguments.length) return d; d = c; e = {}; for (var h = -1, g = -1, i = d.length; ++h < i;) { c = d[h]; c in e || (e[c] = ++g) } return a }; a.range = function (c) { if (!arguments.length) return f; f = c; return a }; a.rangePoints = function (c, h) { if (arguments.length < 2) h = 0; var g = c[0], i = c[1], j = (i - g) / (d.length - 1 + h); f = d.length == 1 ? [(g + i) / 2] : d3.range(g + j * h / 2, i + j / 2, j); b = 0; return a }; a.rangeBands = function (c, h) {
            if (arguments.length <
                2) h = 0; var g = c[0], i = c[1], j = (i - g) / (d.length + h); f = d3.range(g + j * h, i, j); b = j * (1 - h); return a
        }; a.rangeBand = function () { return b }; return a
    }; d3.scale.category10 = function () { return d3.scale.ordinal().range(xa) }; d3.scale.category20 = function () { return d3.scale.ordinal().range(ya) }; d3.scale.category20b = function () { return d3.scale.ordinal().range(za) }; d3.scale.category20c = function () { return d3.scale.ordinal().range(Aa) };
    ...
    d3.svg.arc = function () {
        function a(c) { return c.endAngle } function d(c) { return c.startAngle } function e(c) { return c.outerRadius } function f(c) { return c.innerRadius } function b(c) { var h = f(c), g = e(c), i = d(c) - Math.PI / 2, j = a(c) - Math.PI / 2; c = j - i; var m = Math.cos(i); i = Math.sin(i); var p = Math.cos(j); j = Math.sin(j); return "M" + g * m + "," + g * i + "A" + g + "," + g + " 0 " + (c < Math.PI ? "0" : "1") + ",1 " + g * p + "," + g * j + "L" + h * p + "," + h * j + "A" + h + "," + h + " 0 " + (c < Math.PI ? "0" : "1") + ",0 " + h * m + "," + h * i + "Z" } b.innerRadius = function (c) {
            f = typeof c == "function" ? c : function () { return c };
            return b
        }; b.outerRadius = function (c) { e = typeof c == "function" ? c : function () { return c }; return b }; b.startAngle = function (c) { d = typeof c == "function" ? c : function () { return c }; return b }; b.endAngle = function (c) { a = typeof c == "function" ? c : function () { return c }; return b }; return b
    };
